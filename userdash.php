  ...
  <body>
    <div class="sidebar">
      <div class="logo-details">
        ...
        <span class="logo_name">REF USER</span>
      </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="active">
        ...
        <li>
          <a href="pdf_view.php" target="_blank">
            <i class="bx bx-box"></i>
       ...
       <!-- <li>
        ...
        <li>
          <a href="makeinq.php" target="_blank">
           ...
           <li>
          <a href="invinq.php" target="_blank">
            <i class="bx bx-list-ul"></i>
            <span class="links_name">Inquiry History</span>
          </a>
        </li>
      ...
      <div class="home-content">
        ...
        <div class="sales-boxes">
          <div class="recent-sales box">
            <div class="title">Recent Appeals You Have Made</div>
